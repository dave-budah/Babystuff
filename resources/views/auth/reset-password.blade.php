                            ...
                            <div class="login-form form-item form-stl">
                                ...
                                <form name="frm-login" method="POST" action="{{ route('password.update') }}">
                                    ...
                                    <fieldset class="wrap-input item-width-in-half left-item ">
                                        ...
                                        <input type="password" id="password" name="password" placeholder="Password" autocomplete="new_password">
                                    </fieldset>
                                    <fieldset class="wrap-input item-width-in-half ">
                                        <label for="password_confirmation">Confirm Password *</label>
                                        <input type="password" id="password_confirmation" name="password_confirmation" placeholder="Confirm password" autocomplete="new_password">
                                    </fieldset>
