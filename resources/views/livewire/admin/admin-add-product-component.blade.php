                       ...
                       <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="addProduct">
                           ...
                           <div class="form-group">
                               ...
                               <div class="col-md-4">
                                   ...
                                   @if($image)
                                       <img src="{{$image->temporaryUrl()}}" alt="" width="120" style="margin: 1rem .5rem;">
                                   @endif
                                   @error('image') <p class="text-danger">{{$message}}</p> @enderror
                               </div>
                           </div>
                           <div class="form-group">
                               <label for="sku" class="col-md-4 control-label">Product Gallery</label>
                               <div class="col-md-4">
                                   <input type="file" class="input-file" id="image" wire:model="images" multiple>
                                   @if($images)
