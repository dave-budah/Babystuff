                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" wire:submit.prevent="storeAttribute">
                        <div class="form-group">
                            <label for="categoryName" class="col-md-4 control-label">Attribute Name</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control input-md" id="categoryName" placeholder="Attribute Name" wire:model="name">
