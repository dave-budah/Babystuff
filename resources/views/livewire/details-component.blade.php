                ...
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        @if ($product->sale_price > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now())
                            <div class="wrap-price">
                                ...
                                <del><span class="product-price saleprice">${{$product->regular_price}}</span></del>
                            </div>
                        @else
                        ...
                        <div>
                            @foreach($product->attributeValues->unique('product_attribute_id') as $av)
                                <div class="row" style="margin-top: 20px;">
                                    <div class="col-xs-2">
                                        <h5><b>{{$av->productAttribute->name}}</b></h5>
                                    </div>
                    ...
                    <div class="advance-info">
                        <div class="tab-control normal">
                            ...
                            <a href="#add_infomation" class="tab-control-item">Additional Information</a>
                        ...
                        <div class="tab-contents">
                            ...
                            <div class="tab-content-item " id="add_infomation">
                                <table class="shop_attributes">
                                    <tbody>
                                    <tr>
                                        <th>Weight</th><td class="product_weight">Not provided</td>
                                    </tr>
                                    <tr>
                                        <th>Dimensions</th><td class="product_dimensions">Not provided</td>
                                    </tr>
                                    <tr>
                                        <th>Color</th><td><p>Not specified</p></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                                    ...
                                    <ol class="commentlist">
                                        ...
                                        <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                            <div id="comment-20" class="comment_container">
                                                ...
                                                @else
                                                    <img src="{{asset('assets/images/profile/profile.png')}}" alt="profile image" width="100%">
                                                @endif
                            ...
                            <li class="service">
                                <a class="link-to-service" href="#">
                                    ...
                                    <div class="right-content">
                                        ...
                                        <span class="subtitle">Contact Store</span>
                                        <p class="desc">Shipping charges may vary as per agreement.</p>
                                    </div>
                                </a>
                            </li>
                            ...
                            <li class="service">
                                <a class="link-to-service" href="#">
                                    ...
                                    <div class="right-content">
                                        ...
                                        <p class="desc">Whenever there are free gifts, they will be indicated.</p>
                                    </div>
                                </a>
                            </li>
                            ...
                            <li class="service">
                                <a class="link-to-service" href="#">
                                    ...
                                    <div class="right-content">
                                        ...
                                        <span class="subtitle">Contact store</span>
                                        <p class="desc">Return policy vary based on product.</p>
                                    </div>
                                </a>
                            </li>
                        </ul>
