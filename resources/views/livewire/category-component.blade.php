            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                ...
                <div class="banner-shop">
                    <a href="#" class="banner-link">
                        <figure><img src="{{asset('assets/images/breast_pump.jpg')}}" alt=""></figure>
                    </a>
                </div>
                ...
                <div class="widget mercado-widget filter-widget brand-widget">
                    ...
                    <div class="widget-content">
                        <ul class="list-style vertical-list list-limited" data-show="6">
                            ...
                            <li class="list-item"><a class="filter-link " href="#">CPUs & Processors</a></li>
                            <li class="list-item"><a class="filter-link " href="#">Sound & Speaker</a></li>
                            <li class="list-item"><a class="filter-link " href="#">Shop Smartphone & Tablets</a></li>
                            <li class="list-item default-hiden"><a class="filter-link " href="#">Printer & Ink</a></li>
                            <li class="list-item default-hiden"><a class="filter-link " href="#">CPUs & Processors</a></li>
