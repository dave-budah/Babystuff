                ...
                <ul class="products-cart">
                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="quantity">
                            ...
                            <p class="text-center" style="margin-bottom: -.8rem;"><a href="" wire:click.prevent="switchToSaveForLater('{{$item->rowId}}')" style="color: #333;">Save for later</a></p>
                        </div>
            ...
            <div class="summary">
                <div class="order-summary">
                    ...
                    @if(Session::has('coupon'))
                        <p class="summary-info"><span class="title">Discount ({{Session::get('coupon')['code']}}) <a title="Remove coupon" wire:click.prevent="removeCoupon"
...
{{--                        <p class="summary-info"><span class="title">Shipping</span><b class="index">Free Shipping</b></p>--}}
                    ...
                    <div class="checkout-info">
                        ...
                        @endif
                    @endif
                    <a class="btn btn-checkout text-uppercase" href="#" wire:click.prevent="checkout">Check out</a>
                ...
                <div class="text-center" style="padding: 30px 0;">
                    <div class="text-center">
                        <img src="{{ asset('assets/images/svg/empty_cart.svg') }}" alt="" style="width:150px;">
                    </div>
                    <a class="link-to-shop" href="/shop" style="font-size: 20px; color: rebeccapurple;">Go Shopping</a>
                </div>
            @endif
            <div class="wrap-iten-in-cart">
                    ...
                    <ul class="products-cart">
                        @foreach(Cart::instance('saveForLater')->content() as $item)
                            <li class="pr-cart-item">
                                ...
                                <div class="price-field produtc-price"><p class="price">${{$item->model->regular_price}}</p></div>
                                <div class="quantity">
                                    <p class="text-center" style="margin-bottom: -.8rem;"><a href="" wire:click.prevent="moveToCart('{{$item->rowId}}')">Move to Cart</a></p>
                                </div>
                                <div class="delete">
