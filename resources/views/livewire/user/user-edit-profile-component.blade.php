            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    @if(Session::has('message'))
                        <div class="alert alert-success" role="alert">{{Session::get('message')}}</div{{ Session::get('message') }}</div>
                    @endif
                    ...
                    <div class="col-md-4">
                        ...
                        @elseif ($image)
                            <img src="{{asset('assets/images/profile')}}/{{$image}}" alt="profile image" width="100%">
                        @else
